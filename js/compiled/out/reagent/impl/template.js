...
var G__19946 = o;
(G__19946[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__19948__i < G__19948__a.length) {G__19948__a[G__19948__i] = arguments[G__19948__i + 0]; ++G__19948__i;}
  args = new cljs.core.IndexedSeq(G__19948__a,0);
} 
...
var old_19950 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_19950))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_19950)].join(''):class$));
} else {
}
...
var G__19953 = jsprops;
(G__19953["defaultValue"] = value);

(G__19953["onChange"] = ((function (G__19953,v,value,on_change){
return (function (p1__19951_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__19951_SHARP_);
});})(G__19953,v,value,on_change))
);
...
var vec__19955 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__19955,(0),null);
var id = cljs.core.nth.call(null,vec__19955,(1),null);
var class$ = cljs.core.nth.call(null,vec__19955,(2),null);
...
var temp__4659__auto__ = (function (){var G__19959 = cljs.core.meta.call(null,v);
if((G__19959 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__19959);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__19961_19962 = v;
var G__19961_19963__$1 = (((G__19961_19962 == null))?null:reagent.impl.template.key_from_vec.call(null,G__19961_19962));
if((G__19961_19963__$1 == null)){
} else {
(jsprops["key"] = G__19961_19963__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__19966 = cljs.core.meta.call(null,argv);
if((G__19966 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__19966);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__19967 = (((jsprops == null))?{}:jsprops);
(G__19967["key"] = key);
...
var G__19968 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__19968;
continue;
}
} else {
...
var n__19273__auto___19969 = a.length;
var i_19970 = (0);
while(true){
if((i_19970 < n__19273__auto___19969)){
(a[i_19970] = reagent.impl.template.as_element.call(null,(a[i_19970])));

var G__19971 = (i_19970 + (1));
i_19970 = G__19971;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19273__auto___19972 = a.length;
var i_19973 = (0);
while(true){
if((i_19973 < n__19273__auto___19972)){
var val_19974 = (a[i_19973]);
if((cljs.core.vector_QMARK_.call(null,val_19974)) && ((reagent.impl.template.key_from_vec.call(null,val_19974) == null))){
(o["no-key"] = true);
} else {
}

(a[i_19973] = reagent.impl.template.as_element.call(null,val_19974));

var G__19975 = (i_19973 + (1));
i_19973 = G__19975;
continue;
} else {
}
...
var G__19977 = (cljs.core.count.call(null,argv) - first_child);
switch (G__19977) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__19977){
...
//# sourceMappingURL=template.js.map?rel=1466046458159