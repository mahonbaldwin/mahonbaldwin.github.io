...
var c_19794 = (a[i]);
if(cljs.core.truth_((c_19794["cljsIsDirty"]))){
(c_19794["forceUpdate"])();
} else {
}
...
var G__19798 = c;
var G__19798__$1 = (((G__19798 == null))?null:(G__19798["props"]));
if((G__19798__$1 == null)){
return null;
} else {
return (G__19798__$1["argv"]);
}
});
...
var G__19800_19801 = (c["cljsRatom"]);
if((G__19800_19801 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__19800_19801);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1466046457321